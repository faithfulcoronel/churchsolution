...
export interface IMembershipTypeRepository extends BaseRepository<MembershipType> {}
...
{
  constructor(@inject('IMembershipTypeAdapter') adapter: IMembershipTypeAdapter) {
    super(adapter);
  }
