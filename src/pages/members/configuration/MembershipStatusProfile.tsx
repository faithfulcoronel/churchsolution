...
function MembershipStatusProfile() {
  ...
  return (
    <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-6">
        <BackButton fallbackPath="/members/configuration/membership-status" label="Back to Status" />
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-3">
              <Button variant="outline" onClick={() => navigate('edit')} className="flex items-center" disabled={type.is_system}>
...
export default MembershipStatusProfile;
