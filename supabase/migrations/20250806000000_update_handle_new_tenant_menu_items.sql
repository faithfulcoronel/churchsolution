-- Update handle_new_tenant_registration to also copy default menu items
...
COMMENT ON FUNCTION handle_new_tenant_registration IS
  'Creates a new tenant with roles, default menu items, categories, membership records, and links to default chart of accounts.';
